...
//
//Programa:	PRELAB8  (1 caracter con comunicación serial)	
//
//				
...
#include <xc.h>                 //Incluir la librería del microcontrolador
#include <stdio.h>
...
void main() {
    ...
    SEND_CAR('F');          //Envía el caracter entre " al puerto serial
...
void setup_UART(void) {         //configuracion uart
